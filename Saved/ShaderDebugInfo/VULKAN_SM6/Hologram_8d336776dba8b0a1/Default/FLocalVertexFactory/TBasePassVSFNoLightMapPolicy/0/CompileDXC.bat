...
%DXC% -E Main -T vs_6_2 -spirv -Qunused-arguments -HV 2018 -fvk-use-scalar-layout -fspv-svposition-implicit-invariant -fspv-target-env=vulkan1.3 -Fo BasePassVertexShader.DXC.spv BasePassVertexShader.usf
WHERE %SPIRVCROSS%
IF %ERRORLEVEL% NEQ 0 (
